...
_SPARK_PKGS = {
    ...
    'com.amazonaws:aws-java-sdk:1.7.4',   # https://mvnrepository.com/artifact/org.apache.hadoop/hadoop-aws/2.7.7
...
def initSpark(
    ...
    os.environ['PYSPARK_PYTHON'] = '/opt/miniconda3.8/bin/python3'   # TODO: make generic 'python3'
